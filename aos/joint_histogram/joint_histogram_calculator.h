...
namespace impl {
template <class T>
class JointHistogramCalculatorDefault
    : public JointHistogramCalculatorInterface<T> {
    // Custom hash function for std::pair<int, int>
  ...
  public:
    ...
    ~JointHistogramCalculatorDefault() override {
        logi("{}", "JointHistogramCalculatorDefault dtor");
    }
};
/**
