...
class NetPositionStrategyDefault
    : public NetPositionStrategyInterface<Price, Qty> {
    PnlRealizedStorageInterface<Price, Qty>& pnl_realized_storage_;
    PnlUnRealizedStorageInterface<Price, Qty>& pnl_unrealized_storage_;

  public:
    NetPositionStrategyDefault(
        PnlRealizedStorageInterface<Price, Qty>& pnl_realized_storage,
...
template <typename Price, typename Qty>
class HedgedPositionStrategyDefault
    : public HedgePositionStrategyInterface<Price, Qty> {
    PnlRealizedStorageInterface<Price, Qty>& pnl_realized_storage_;
    PnlUnRealizedStorageInterface<Price, Qty>& pnl_unrealized_storage_;

  public:
    HedgedPositionStrategyDefault(
        PnlRealizedStorageInterface<Price, Qty>& pnl_realized_storage,
        PnlUnRealizedStorageInterface<Price, Qty>& pnl_unrealized_storage)
        : pnl_realized_storage_(pnl_realized_storage),
          pnl_unrealized_storage_(pnl_unrealized_storage) {}
