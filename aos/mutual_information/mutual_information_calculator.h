...
class MutualInformationCalculatorDefault
    : public MutualInformationCalculatorInterface<HashT, T> {
    HistogramCalculatorInterface<T>& hist_calculator_;
    JointHistogramCalculatorInterface<T>& joint_hist_calculator_;

  public:
    MutualInformationCalculatorDefault(
        HistogramCalculatorInterface<T>& hist_calculator,
        JointHistogramCalculatorInterface<T>& joint_hist_calculator)
    ...
    std::pair<bool, T> ComputeMutualInformation(
        SlidingWindowStorageInterface<HashT, T>& window_storage,
    ...
    ~MutualInformationCalculatorDefault() override {
        logi("MutualInformationCalculatorDefault dtor");
    }
};
