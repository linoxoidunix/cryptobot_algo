    ...
    try {
        {
            ...
            using Qty                 = double;
            using Uid                 = size_t;
            using RealizedPnlStorageT = aos::impl::RealizedPnlStorage<
            ...
            long_position.AddPosition(common::ExchangeId::kBinance,
            ...
            long_position.RemovePosition(common::ExchangeId::kBinance,
                                         aos::TradingPair::kBTCUSDT, 55.0, 230);
        ...
        }
        {
            ...
            short_position.AddPosition(common::ExchangeId::kBinance,
                                       aos::TradingPair::kBTCUSDT, 50.0, -100);
            ...
            short_position.RemovePosition(common::ExchangeId::kBinance,
                                          aos::TradingPair::kBTCUSDT, 55.0,
                                          -80);
        ...
        }
        {
            ...
            aos::impl::HedgePosition<Price, Qty,
                                     common::MemoryPoolNotThreadSafety>
                position(position_strategy);  // Позиция с хеджированием
                                              // (длинная и короткая)

            // Логгирование добавления позиции (long)
            logi("Adding 100 units at price 50.0 (long position)");
            position.AddPosition(common::ExchangeId::kBinance,
                                 aos::TradingPair::kBTCUSDT, 50.0, 100);
            ...
            position.RemovePosition(common::ExchangeId::kBinance,
                                    aos::TradingPair::kBTCUSDT, 55.0, 155);
