...
class Strategy {
    Config config_;
    aoe::bybit::spot::main_net::InfrastructureNotifierInterface<Price, Qty>&
        infra_;
  ...
  private:
    void SetStrategy() {
        ...
        strategy_init_success_ = status_set_cb_on_best_bid_change &&
                                 status_set_cb_on_best_ask_change;
    }
};
};  // namespace str
