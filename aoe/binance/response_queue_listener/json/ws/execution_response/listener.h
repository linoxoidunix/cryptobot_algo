...
// #include
// "aoe/bybit/parser/json/ws/execution_response/i_execution_event_parser.h"
...
//             parser.iterate(padded_json).get(doc); std::string str(msg.data(),
//             msg.size()); logi("parsed JSON: {}", str); if (error) {
