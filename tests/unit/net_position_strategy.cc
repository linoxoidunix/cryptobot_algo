...
class NetPositionStrategyTest : public ::testing::Test {
  protected:
    ...
    void SetUp() override {
        ...
        strategy_ = std::make_unique<aos::impl::NetPositionStrategy<
            Price, Qty, common::MemoryPoolNotThreadSafety>>(
...
TEST_F(NetPositionStrategyTest, UnrealizedPnlWithoutBBOIsZero) {
    ...
    ptr_unrealized_storage_->UpdatePosition(common::ExchangeId::kBinance,
                                            aos::TradingPair::kBTCUSDT,
                                            avg_price, net_qty);
    auto [status, pnl] = ptr_unrealized_storage_->GetUnRealizedPnl(
        common::ExchangeId::kBinance, aos::TradingPair::kBTCUSDT);
...
TEST_F(NetPositionStrategyTest, UnrealizedPnlWithBBOAfterPosition) {
    ...
    // ptr_unrealized_storage_->UpdatePosition(common::ExchangeId::kBinance, {2,
    // 1},
    //                                        avg_price, net_qty);
    strategy_->Add(common::ExchangeId::kBinance, aos::TradingPair::kBTCUSDT,
...
TEST_F(NetPositionStrategyTest, UnrealizedPnlIsUpdatedOnNewBBO) {
    ...
    auto [status1, pnl1] = ptr_unrealized_storage_->GetUnRealizedPnl(
        common::ExchangeId::kBinance, aos::TradingPair::kBTCUSDT);
    EXPECT_TRUE(status1);
    ...
    auto [status2, pnl2] = ptr_unrealized_storage_->GetUnRealizedPnl(
        common::ExchangeId::kBinance, aos::TradingPair::kBTCUSDT);
    EXPECT_TRUE(status2);
