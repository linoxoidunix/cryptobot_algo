    ...
    HedgedPositionSorageByPairDefaultTest()
        : realized_pnl_storage_(realized_pnl_calculator_),
          ...
          position_storage_by_pair_([this]() {
              return aos::impl::HedgedPositionDefault<Price, Qty>(strategy_);
          }) {
...
TEST_F(HedgedPositionSorageByPairDefaultTest, AddAndRemoveTest) {
    ...
    position_storage_by_pair_.AddPosition(
    ...
    position_storage_by_pair_.AddPosition(common::ExchangeId::kBinance,
    ...
    position_storage_by_pair_.AddPosition(
        common::ExchangeId::kBinance, aos::TradingPair::kBTCUSDT, 60.0, -50);
    ...
    position_storage_by_pair_.RemovePosition(common::ExchangeId::kBinance,
    ...
    position_storage_by_pair_.RemovePosition(
